@REM archiveitprototype launcher script
@REM
@REM Envioronment:
@REM JAVA_HOME - location of a JDK home dir (optional if java on path)
@REM CFG_OPTS  - JVM options (optional)
@REM Configuration:
@REM ARCHIVEITPROTOTYPE_config.txt found in the ARCHIVEITPROTOTYPE_HOME.
@setlocal enabledelayedexpansion

@echo off
if "%ARCHIVEITPROTOTYPE_HOME%"=="" set "ARCHIVEITPROTOTYPE_HOME=%~dp0\\.."
set ERROR_CODE=0

set "APP_LIB_DIR=%ARCHIVEITPROTOTYPE_HOME%\lib\"
...
set "CFG_FILE=%ARCHIVEITPROTOTYPE_HOME%\ARCHIVEITPROTOTYPE_config.txt"
set CFG_OPTS=
if exist %CFG_FILE% (
...
if "%JAVAOK%"=="false" (
  ...
  echo and download a valid Java JDK and install before running archiveitprototype.
  echo.
